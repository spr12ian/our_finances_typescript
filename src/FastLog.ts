...
// ────────────────────────────────────────────────────────────
/** Triggers — bound to globalThis to be safe under bundlers */
// ────────────────────────────────────────────────────────────
// function _onEdit(e: GoogleAppsScript.Events.SheetsOnEdit) {
//   try {
//     FastLog.log("onEdit", {
...
//     // ... your fast logic ...
//   } catch (err) {
//     FastLog.error("onEdit error", err);
//   } finally {
//     FastLog.persistRing();
//   }
// }

// function _onChange(e: GoogleAppsScript.Events.SheetsOnChange) {
//   try {
//     FastLog.log("onChange", { changeType: e.changeType });
//     // ... your logic for INSERT_ROW, etc. ...
//   } catch (err) {
//     FastLog.error("onChange error", err);
//   } finally {
//     FastLog.persistRing();
//   }
// }
...
//     .createMenu("Logging")
//     .addItem("Snapshot Status Log", "FastLog.manualSnapshot")
//     .addItem("Clear Log", "FastLog.clear")
//     .addToUi();
// }

// // Ensure GAS sees the trigger names (works even if wrapped)
// ;(globalThis as any).onEdit = _onEdit;
// ;(globalThis as any).onChange = _onChange;
// ;(globalThis as any).onOpen = _onOpen;
